...
class CobblerSystem:
    ...
    def set_kernel_opts(self, **kwargs):
        """
        Sets kernel options.  Pass them as named keywords.  E.g., set_kernel_ops(self, foo=bar)
        For kernel opts without values, set it to None.  e.g. set_kernel_opts(self, quiet=None)
        """
    ...
    def set_ks_meta(self, **kwargs):
        """
        Sets kickstart metadata   Pass as named keywords.  E.g., set_ks_meta(self, foo=bar)
        """
